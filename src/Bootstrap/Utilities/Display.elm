module Bootstrap.Utilities.Display exposing
    ...
    , inlineBlock, inlineBlockSm, inlineBlockMd, inlineBlockLg, inlineBlockXl
    , table, tableSm, tableMd, tableLg, tableXl
    , tableCell, tableCellSm, tableCellMd, tableCellLg, tableCellXl
