module BSMain exposing (Model, Msg(..), accordion, cardOne, cardThree, cardTwo, cards, colStyles, customPagination, gridForm, init, listGroup, listGroup2, main, mainContent, modal, modalBody, navbar, popoverButton, popoverContent, progressBars, rowStyles, simpleForm, simplePaginationList, subscriptions, tables, tabs, update, view)
...
simpleForm =
    Form.form
        [ Spacing.mt5, Spacing.mb5, Spacing.pt5, Spacing.pt5Xl ]
        [ Grid.row []
            [ Grid.col [ Col.xs12 ] 
                [ h1 [] [ text "Simple Form" ]
                ]
            ...
            , Grid.col [ Col.sm4 ]
                ...
                , Form.invalidFeedback [] [ text "This went well !" ]
                ]
            , Grid.col [ Col.sm6 ] 
                [ Form.label [] [ text "A range slider" ]
                , Range.range
                    [ Range.id "myRange"
                    , Range.min "-10"
                    , Range.max "10"
            ...
            , Grid.col [ Col.sm6 ] 
                ...
                , InputGrp.config
                    ...
                    |> InputGrp.predecessors
                        [ InputGrp.span [] [ text "@" ] ]
                    |> InputGrp.successors
                        [ InputGrp.button [ Button.small, Button.outlinePrimary ] [ text "Do it!" ]
                        ]
                    |> InputGrp.view
                , InputGrp.config
                    (InputGrp.password [])
                ...
                , InputGrp.config
                    ...
                    |> InputGrp.successors
                        [ InputGrp.button [ Button.outlinePrimary ] [ text "Do it!" ]
                        , InputGrp.button [ Button.outlineSecondary ] [ text "Cancel" ]
                        ]
                    |> InputGrp.view
                ]
            ] 
        ...
        , Form.form [ class "container" ]
            ...
            , Grid.row []
                [ Grid.colForm 
                    <| Form.colLabelLg 
                        [ Col.xs4
                        , Col.attrs [ attribute "for" "rowinput" ] 
                        ] [ text "Fill in:" ]

                , Grid.col [ Col.xs8 ]
                    [ Input.text
                        [ Input.id "rowinput", Input.success, Input.large ]
            ...
            , Grid.row []
                [ Grid.colForm <| 
                    Form.colLabelLg 
                        [ Col.xs4 
                        , Col.attrs [ attribute "for" "postal" ]
                        ] [ text "Postal" ]
                        
                , Grid.col [ Col.xs4 ]
                    [ Input.text [ Input.id "postal", Input.large ]
            ...
            , Grid.row []
                [ Grid.col [ Col.offsetXs4, Col.xs8 ]
                    [ Chk.checkbox [] "Lonely checker" ]
                ]
            , Grid.row []
                [ Grid.colForm <| Form.colLabel [ Col.xs4 ] [ text "Row select:" ]
                , Grid.col [ Col.xs8 ]
